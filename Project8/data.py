...
class Data:
    ...
    def read(self, filename):
        ...
        x = 0
        # loop over the lines
        print('starting reading of', filename)
        ...
        if headers == None:
            ...
            for header in headers:
                if isinstance(header, int):
                    ...
                    #this try-except is here because when I run task2.py, the first key in header2col is 
                    #some weird symbols that I can't type and then a 0. Not a clue why. This handles it.
                    try:
                        relevant_headers.append(int(self.header2col[header]))    
                    except:
                        relevant_headers.append(0)
    ...
    def add_header2col(self, index):
        self.header2col[index] = len(self.header2col)
