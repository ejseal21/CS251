...
def main(argv):
    ...
    if len(argv) > 4:
        ...
        traincats = traincatdata.limit_columns( [traincatdata.get_headers()[0]] )
        testcats = testcatdata.limit_columns( [testcatdata.get_headers()[0]] )
        ...
        traincats = dtrain.limit_columns( [dtrain.get_headers()[-1]] )
        testcats = dtest.limit_columns( [dtest.get_headers()[-1]] )
    ...
    # print(knnc10.confusion_matrix_str(knnc10.confusion_matrix()))
